<template>
	<div class="portal-layout">
		...
		<!-- Main Routed View (S8: keep-alive đúng 3 list views, max=3; data tươi do load ở mounted + reload sau mutate, không onActivated) -->
		<main class="main-content">
			<router-view v-slot="{ Component }">
				<Suspense>
					<template #default>
						<keep-alive include="OrdersView,CatalogView,QuotesView" :max="3">
