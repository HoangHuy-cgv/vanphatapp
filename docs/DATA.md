...
Source: `data/clean-data/*.csv` (import via `scripts/import_master_data.py`). Counts: 293 Items, 117 Customers, 14 Suppliers, 68 BOMs, 11 Users.
...
- Naming: masters `PREFIX-.#####` (no reset); transactions `PREFIX-.YY..MM.-.###` (monthly reset): `KH-` `NCC-` `TRUC-` `BG-` `DH-` `MH-` `LSX-` `GH-` `NH-` `HD-` `PT-` `PC-`.
