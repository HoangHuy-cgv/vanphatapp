...
|---|---|---|---|
| 8 | 2026-09-16 | Rebuild ERPNext Native v16 baseline; transfer order lifecycle 100% to Desk; Portal Cockpit with 5-tab Catalog, Quick CRUD, and Quotation Engine | Accepted (supersedes order parts of ADR-005, ADR-006) |
